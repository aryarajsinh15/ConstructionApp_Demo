...
export class SidenavComponent implements OnInit {
  ...
  ngOnInit() {
    this.firmName = this.storageService.getValue('firmName') != "null" ? this.storageService.getValue('firmName') : "Super Admin";
    this.fullName = this.storageService.getValue('fullName');
    this.userPhoto = this.storageService.getValue('userImage'); 
    this.storageService.subject.subscribe(next => {
      this.userPhoto =next; 
    });
  }
  ...
  handleImageError(){
    this.userPhoto =  "../../../assets/img/shaligram_logo/default-user-profile.svg"; 
  }
}
